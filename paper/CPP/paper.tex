...
\lstdefinelanguage{isabelle}{%
    keywords=[1]{context,type_synonym,typedef,datatype,fun,function,abbreviation,definition,proof,lemma,theorem,corollary,inductive,record},
    keywordstyle=[1]\bfseries\color{isarblue},
    keywords=[2]{where,assumes,shows,and,fixes,defines,begin,end},
...
%\end{lstlisting}
%
% Maybe show \lstinline|ufsi_size_Abs_ufsi| here.
